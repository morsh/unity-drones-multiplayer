...
public class WMRCameraFollowScript : MonoBehaviour {
    ...
    private void FixedUpdate() {
        ...
        transform.position = Vector3.SmoothDamp(transform.position, drone.transform.TransformPoint(behindPosition) + Vector3.up, ref velocityCameraFollow, 0.01f);
